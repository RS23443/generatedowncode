...
import org.firstinspires.ftc.teamcode.ModulesToImport.systems.Intake;
...
public class PurePursiutv1 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        double horizontalOffset = 7.0; // Example distance of horizontal wheel from center
        ...
        for (SplineGenerator.SplineSegment segment : spline) {
            for (double t = 0; t <= 1; t += 0.05) {
                ...
                // Apply power
                robot.setMecanumPower(forward, strafe, rotate, acceleration);
                sleep(50);
            }
        }
